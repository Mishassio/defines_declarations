...
export PRJ_DIR?=
ifeq (${PRJ_DIR},)
  $(error You Must Set PRJ_DIR)
endif
export _OUTPUT_DEFINES_SV_FILE_NAME?=defs.sv
export _OUTPUT_DEFINES_SV_FILE_DIR?=${BUILD_DIR}
export _OUTPUT_DEFINES_SV_FILE?=${_OUTPUT_DEFINES_SV_FILE_DIR}/${_OUTPUT_DEFINES_SV_FILE_NAME}
...
run:
	vlog +incdir+${_OUTPUT_DEFINES_SV_FILE_DIR} +define+DEFS_SRC=${_OUTPUT_DEFINES_SV_FILE_NAME} ${PRJ_DIR}/top_tb.sv
